        ...
        <div  className=" h-100 w-100 bg-cocinarte">
            ...
            <div className={`vh-100 ${store.sideBar===false ? 'sidebar-close':'sidebar-open'}`}>
                ...
                <form onSubmit={editRecipe} className="container d-flex flex-column mt-4 gap-3">
                    ...
                    <div className="d-flex flex-column">
                        <label className="form-label label-create-recipe" htmlFor="steps">Steps:</label>
                        <textarea value={steps} id="steps" className="form-control input-create-recipe mb-4" type="text" placeholder="Steps" onChange={(e)=>setSteps(e.target.value)} />
                    </div>
                    <div className="d-flex flex-column">
                        <label className="form-label label-create-recipe" htmlFor="img">Show us your finished recipe images!</label>
                        <input className="form-control input-create-recipe mb-4" id="img" type="file" multiple onChange={uploadImages} />
                    </div>
                    <label className="form-label label-create-recipe">Categories:</label>
